...
export const WIDGETS: Record<WidgetKey, WidgetDef> = {
  ...
  "page-budget": { key: "page-budget", title: "Pos Anggaran", description: "Atur pos tetap dan pantau pemakaian bulan ini.", group: "halaman", spans: ["xs", "sm", "md"], rows: [1, 2], defaultSpan: "xs", defaultRows: 1, defaultVisible: false },
