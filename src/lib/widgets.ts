...
export const WIDGETS: Record<WidgetKey, WidgetDef> = {
  ...
  "page-nudge": { key: "page-nudge", title: "Nudge", description: "Lihat hal yang mungkin perlu kamu perhatikan.", group: "halaman", spans: ["xs", "sm", "md"], rows: [1, 2], defaultSpan: "xs", defaultRows: 1, defaultVisible: false },
